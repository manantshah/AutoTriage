...
def read_inbound(inbound_email : Inbound):
    ...
    cur = db_conn.cursor()
    cur.execute("INSERT INTO Inbound_Emails (customer_email, support_email, subject_line, email_body, email_received_at, GAS_fired_at, system_logged_at) VALUES (%s, %s, %s, %s, %s, %s, NOW()) RETURNING id;", (inbound_email.customer_email, inbound_email.support_email, inbound_email.subject_line, inbound_email.email_body, inbound_email.email_received_at, inbound_email.GAS_fired_at))
